...
$row = mysqli_fetch_assoc($rs);
                            ...
                            <div class="col-sm-6">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
										   ...
										   <button type="submit" class="btn btn-primary" name="SLIDER">Update</button>
										   <?php }else{?>
                                ...
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="table-responsive">
                                            <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
												...
												<?php 
	$i=1;
	 $query1="SELECT * FROM `mk_slider` ORDER BY `id` ASC";
	...
	<td><a href="slider.php?id=<?php echo $row1['id'];?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
	/ 
	  <a href="post.php?id=<?php echo $row1['id']; ?>&DELETE_SLIDER" class="btn btn-danger" onclick="return confirm('Are you sure?');">
