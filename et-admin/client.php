...
$rs=mysqli_query($con,"SELECT * FROM `slider` WHERE `id`='".$_REQUEST['id']."'");
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <div class="content">
                            ...
                            <div class="col-sm-8">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                       ...
                                       <form name="Client Add"  action="addclient.php" method="post" enctype="multipart/form-data">
										   ...
										   <input type="hidden" name="edit_id" value="<?php echo $_REQUEST['id'];?>">	
										    ...
										    <div class="form-group row">
                                                <label for="exampleInputFile" class="col-sm-3">Client's Name </label>
												<div class="col-sm-6">
											  ...
											  <div class="form-group row">
												...
												<div class="col-sm-6">
                                                <textarea name="desc" class="form-control" style="height:100px"  required ><?php echo $row['desc']?></textarea>
                     ...
                     <img src="assets/client/<?php echo $row['photo']?>" width="100" height="100">
                      ...
                      <?php }?>
                                           ...
                                           <center>
										   <?php if(!empty($_GET['id'])){?>
										   <button type="submit" class="btn btn-primary" name="CLIENT">Update</button>
										   <?php }else{?>
										   <button type="submit" class="btn btn-primary" name="CLIENT">Submit</button>
										   <?php }?>
