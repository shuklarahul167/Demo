...
$rs=mysqli_query($con,"SELECT * FROM `tbl_wheels_tire_product` WHERE `id`='".$_REQUEST['id']."'");
                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Wheels & Tire Product Add </h1>
                              
                                <ol class="breadcrumb">
                                    <li><a href="dashboard.php"><i class="pe-7s-home"></i> Dashboard</a></li>                             
                                    <li class="active">Wheels & Tire Product Add </li>
                                </ol>
                            </div>
								 ...
								 <input type="hidden" name="edit_id" value="<?php echo $_REQUEST['id'];?>">	
										   ...
										   <div class="form-group row">
											...
											<div class="form-group row">
											 ...
											 <div class="form-group row">
                                                <label for="exampleInputFile" class="col-sm-3">Tire Size </label>
												<div class="col-sm-6">
											...
											<div class="form-group row">
                                                <label for="exampleInputFile" class="col-sm-3">Wheels Size </label>
												<div class="col-sm-6">
											...
											<div class="form-group row">
                                                <label for="exampleInputFile" class="col-sm-3"> Retail </label>
												<div class="col-sm-6">
                                              <input type="text"  name="retail" value="<?php echo $row['retail'];?>" class="form-control"  required >
											...
											<div class="form-group row">
											 ...
											 <div class="form-group row">
                                                <label for="exampleInputFile" class="col-sm-3">Tire Image Upload</label>
												<div class="col-sm-6">
                                              <input type="file" name="tire" class="form-control"  <?php if(empty($_GET['id'])){?>required <?php }?> >
												
                                            </div><div class="col-sm-3">
											 <?php if(!empty($_GET['id'])){?>

                     <img src="assets/products/<?php echo $row['tire']?>" width="100" height="100">
                      ...
                      <?php }?>
											...
											<div class="form-group row">
                                                <label for="exampleInputFile" class="col-sm-3">Wheels Image Upload</label>
												<div class="col-sm-6">
                                              <input type="file" name="wheels" class="form-control"   <?php if(empty($_GET['id'])){?>required <?php }?> >
												
                                            </div><div class="col-sm-3">
											 <?php if(!empty($_GET['id'])){?>

                     <img src="assets/products/<?php echo $row['wheels']?>" width="100" height="100">
                      ...
                      <?php }?>
                                          ...
                                          <br/>
                                           ...
                                           <center>
										   <?php if(!empty($_GET['id'])){?>
										   <button type="submit" class="btn btn-primary" name="PRODUCT_WHEELS_TIRE">Update</button>
										   <?php }else{?>
										   <button type="submit" class="btn btn-primary" name="PRODUCT_WHEELS_TIRE">Submit</button>
										   <?php }?>
