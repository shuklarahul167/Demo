...
$rs=mysqli_query($con,"SELECT * FROM `tbl_year` WHERE `id`='".$_REQUEST['id']."'");
$row = mysqli_fetch_assoc($rs);
                                    ...
                                    <div class="panel-body">
										   ...
										   <input type="hidden" name="edit_id" value="<?php echo $_REQUEST['id'];?>">	
                                            ...
                                            <div class="form-group row">
                                                <label for="exampleInputFile" class="col-sm-4">Year </label>
												<div class="col-sm-8">
                                                <input type="text" name="year" maxlength="4"	 placeholder="2000 (Year)" class="form-control" value="<?php echo $row['year'];?>"  required />
										   ...
										   <button type="submit" class="btn btn-primary" name="YEAR">Update</button>
										   <?php }else{?>
										   <button type="submit" class="btn btn-primary" name="YEAR">Submit</button>
										   <?php }?>
                                ...
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="table-responsive">
                                            <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
												...
												<?php 
	$i=1;
	$query="SELECT * FROM `tbl_year` ORDER BY `id` DESC";
	...
	<td><a href="year.php?id=<?php echo $row['id'];?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
	/ 
	  <a href="post.php?id=<?php echo $row['id']; ?>&DELETE_YR" class="btn btn-danger" onclick="return confirm('Are you sure?');">
