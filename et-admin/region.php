...
$rs=mysqli_query($con,"SELECT * FROM `region` WHERE `id`='".$_REQUEST['id']."'");
            ...
            <div class="content-wrapper">
                <div class="container">
                    ...
                    <div class="content">
                            ...
                            <div class="col-sm-8">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                       ...
                                       <form name="Country Add"  action="addregion.php" method="post" enctype="multipart/form-data">
                     ...
                     <img src="assets/region/<?php echo $row['photo']?>" width="100" height="100">
                      ...
                      <?php }?>
                                           ...
                                           <center>
										   <?php if(!empty($_GET['id'])){?>
										   <button type="submit" class="btn btn-primary" name="COUNTRY">Update</button>
										   <?php }else{?>
										   <button type="submit" class="btn btn-primary" name="COUNTRY">Submit</button>
										   <?php }?>
