                    ...
                    <div class="content">
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                <h1>Wheels Product List </h1>
                              
                                <ol class="breadcrumb">
                                    <li><a href="dashboard.php"><i class="pe-7s-home"></i> Dashboard</a></li>                                  
                                    <li class="active">Wheels Product List </li>
                                </ol>
                            </div>
                      ...
                      <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                       ...
                       <tbody>
				        <?php 
						$i=1;
						$query="SELECT * FROM `tbl_wheels_product` ORDER BY `id` DESC";
						$res=mysqli_query($con,$query);
						while($row=mysqli_fetch_array($res)){
		                       ?>
							<tr>
							<td><?php echo $i; $i++;?> </td>
							<td><img src="assets/products/<?php echo $row['img'];?>" width='60' height='40' /></td>		
							...
							<td><a href="wheels_product.php?id=<?php echo $row['id'];?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
								/ <a href="post.php?id=<?php echo $row['id']; ?>&DELETE_WHEELS" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>	
						</tr>
