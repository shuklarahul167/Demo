...
$rs=mysqli_query($con,"SELECT * FROM `buy` WHERE `id`='".$_REQUEST['id']."'");
                        ...
                        <div class="content-header">
                            ...
                            <div class="header-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">Buy Leads Add </li>
                                </ol>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <div class="panel panel-bd ">
                                    ...
                                    <div class="panel-body">
                                       ...
                                       <form name="Buy Leads Add"  action="addbuy.php" method="post" enctype="multipart/form-data">
										   ...
										   <button type="submit" class="btn btn-primary" name="BUY">Update</button>
										   <?php }else{?>
